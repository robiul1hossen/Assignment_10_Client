...
const Video = () => {
  return (
    <div className="">
      ...
      <div>
        <div className="w-100 my-4 d-lg-flex gap-5">
          <iframe
            width="100%"
            height="400"
          ...
          <div>
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel incidunt ad ex tempora corrupti
            vitae.perspiciatis quia cupiditate voluptatum repudiandae officia.
